...
* [cfn-python-lint](https://github.com/aws-cloudformation/cfn-python-lint) ⭐ 2,639 | 🐛 86 | 🌐 Python | 📅 2026-09-05: Validate CloudFormation yaml/json templates against the CloudFormation spec and additional checks. Includes checking valid values for resource properties and best practices.
...
* [aws-cdk](https://github.com/aws/aws-cdk) ⭐ 12,888 | 🐛 2,862 | 🌐 TypeScript | 📅 2026-09-04: The AWS Cloud Development Kit (AWS CDK) is an open-source software development framework to define cloud infrastructure in code and provision it through AWS CloudFormation.
...
* [OpenJS Architect](https://github.com/architect/architect) ⭐ 2,622 | 🐛 63 | 🌐 JavaScript | 📅 2026-09-05: Generate AWS CloudFormation and AWS Serverless Application Model code from a very terse and friendly high level manifest file written in `JSON`, `YAML`, `TOML` or `.arc` format
