...
* [cfn-python-lint](https://github.com/aws-cloudformation/cfn-python-lint) ⭐ 2,641 | 🐛 78 | 🌐 Python | 📅 2026-09-19: Validate CloudFormation yaml/json templates against the CloudFormation spec and additional checks. Includes checking valid values for resource properties and best practices.
...
* [cfn\_nag](https://github.com/stelligent/cfn_nag) ⭐ 1,310 | 🐛 84 | 🌐 Ruby | 📅 2024-08-01: The cfn-nag tool looks for patterns in CloudFormation templates that may indicate insecure infrastructure.
...
* [Visual Studio Code extension](https://github.com/aws-cloudformation/aws-cfn-lint-visual-studio-code) ⭐ 289 | 🐛 45 | 🌐 JavaScript | 📅 2026-09-19: CloudFormation Linter integration, autocompletion, reference documentation links on hover
...
* [aws-cdk](https://github.com/aws/aws-cdk) ⭐ 12,904 | 🐛 2,862 | 🌐 TypeScript | 📅 2026-09-18: The AWS Cloud Development Kit (AWS CDK) is an open-source software development framework to define cloud infrastructure in code and provision it through AWS CloudFormation.
* [serverless-application-model](https://github.com/awslabs/serverless-application-model) ⭐ 9,568 | 🐛 112 | 🌐 Python | 📅 2026-09-15: The AWS Serverless Application Model (SAM) is an open-source framework for building serverless applications. It provides shorthand syntax to express functions, APIs, databases, and event source mappings. With just a few lines of configuration, you can define the application you want and model it.
* [eksctl](https://github.com/weaveworks/eksctl) ⭐ 5,211 | 🐛 96 | 🌐 Go | 📅 2026-09-18: A CLI tool that uses CloudFormation to create clusters on EKS.
* [troposphere (Python)](https://github.com/cloudtools/troposphere) ⭐ 4,944 | 🐛 163 | 🌐 Python | 📅 2026-09-19: The troposphere library allows for easier creation of the AWS CloudFormation JSON by writing Python code to describe the AWS resources. troposphere also includes some basic support for OpenStack resources via Heat.
...
* [cloudformation-cli](https://github.com/aws-cloudformation/cloudformation-cli) ⭐ 337 | 🐛 156 | 🌐 Python | 📅 2026-09-04: The CloudFormation Provider Development Toolkit allows you to author your own resource providers that can be used by CloudFormation.
...
* [aws-cloudformation-coverage-roadmap](https://github.com/aws-cloudformation/aws-cloudformation-coverage-roadmap) ⭐ 1,140 | 🐛 1,343 | 📅 2026-08-14: This is a public roadmap focused on upcoming coverage support for CloudFormation. Coverage prioritisation is influenced by contributions and feedback to this roadmap.
